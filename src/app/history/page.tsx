    ...
    events: [
      {
        ...
        description: 'British forces begin expelling Acadians from Nova Scotia. Over the following decades, thousands of displaced Acadians make their way to Louisiana, drawn by the French-speaking culture and welcoming bayou lands.',
        type: 'milestone',
      },
      {
        year: '~1800',
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: 'Dudley J. LeBlanc is born near Youngsville in Lafayette Parish. He would later become a Louisiana state senator, Cajun culture preservationist, and entrepreneur famous for Hadacol, a patent medicine that became a cultural phenomenon in the 1950s.',
        type: 'notable',
      },
    ],
  },
...
const notableFigures = [
  ...
  },
  {
    ...
    years: '1894-1971',
    description: 'Louisiana politician and entrepreneur born near Youngsville in Lafayette Parish. State Senator, Cajun culture preservationist, and creator of the Hadacol patent medicine fortune.',
  },
]
    ...
    <>
      ...
      <section className="section-article bg-white">
        <div className="container-custom">
          ...
          >
            <Link href="/history/notable-figures" className="btn-secondary group">
            ...
            >
              ...
              <div className="prose-article text-white/80">
                ...
                <p>
                  ...
                  crawfish étouffée and boudin, in the music that fills dance halls, and in
