            ...
            >
              ...
              <blockquote className="border-l-4 border-museum-red pl-6 my-10">
                <p className="text-xl font-display text-museum-charcoal italic">
                  &quot;We didn&apos;t just survive the exile—we built a new homeland.
                  This museum honors the hands that cleared the land, the faith that
                  sustained the journey, and the families who made Youngsville home.&quot;
                </p>
              </blockquote>
      ...
      <section className="section-padding bg-museum-cream relative texture-paper">
        <div className="container-custom mb-12">
          ...
          >
            ...
            <Link href="/history" className="btn-secondary group self-start md:self-auto">
              Full Timeline
              <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
            </Link>
          </motion.div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <h2 className="heading-section text-white max-w-3xl">
              From sugar mills to city streets—two centuries of resilience
            </h2>
          </motion.div>
        </div>
      </section>
